...
$productBottoms = $Pro->getByCategory("Bottoms", $start, $limit);
?>
        ...
        <div class="layout-arrival">
            ...
            <div class="pagination">
                <?php if ($current_page > 1 && $total_page > 1) : ?>
                    <a class="btn btn-outline-primary pagination-btn" href="bottom.php?page=<?= $current_page - 1 ?>">Prev</a>
                <?php endif; ?>
                <?php for ($i = 1; $i <= $total_page; $i++) : ?>
                    <?php if ($i == $current_page) : ?>
                        <span><a class="btn btn-outline-primary pagination-btn" href="bottom.php?page=<?= $i ?>"><?= $i ?></a></span>
                    <?php else : ?>
                        <a class="btn btn-outline-primary pagination-btn" href="bottom.php?page=<?= $i ?>"><?= $i ?></a>
                    <?php endif; ?>
                <?php endfor; ?>
                <?php if ($current_page < $total_page && $total_page > 1) : ?>
                    <a class="btn btn-outline-primary pagination-btn" href="bottom.php?page=<?= $current_page + 1 ?>">Next</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
